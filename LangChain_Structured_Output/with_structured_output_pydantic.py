...
class review(BaseModel):
    name_of_item: str = Field(description="About which item the review is?")
    ...
    sentiment: Literal["pos", "neg", "neu"] = Field(description='Is the review postive, negative or neutral?')

    pros: Optional[list[str]] = Field(description="Pros of the items given in the review in list format.", default=None)

    cons: Optional[list[str]] = Field(description="Cons of the items given in the review in list format.", default=None)
    
    rating: Optional[str] = Field(description='What rating does the user give to the specified item in the review?', default="0")

    reviewer_name: Optional[str] = Field(description='What is the name of the reviewer?', default=None)
